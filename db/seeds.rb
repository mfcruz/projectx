...
if User.count == 0
    ...
    member      = User.new(role: 'member', email: 'member@projectx.com', first_name: 'Diana', last_name: 'Prince', password: 'abc123', password_confirmation: "abc123", created_at: DateTime.now, updated_at: DateTime.now)
    member.save!
    puts "Member account has been created"
end